...
1. 左側メニューから **「設定」** を開きます
2. **Kintoneドメイン** 欄に、貴組合のKintoneドメインを入力します
...
1. ログイン画面に戻り、KintoneのログインIDとパスワードでログインします
2. ログインに成功すると、ダッシュボードが表示されます

> **APIトークンについて**
> システムはKintoneのAPIトークンを使用してデータにアクセスします。
> トークンは初回ログイン時に自動的に設定されます。
> 「認証エラー」が表示される場合は担当のシステム管理者に連絡してください。
